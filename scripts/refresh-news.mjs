...
const SPOTLIGHT_POOL = [
  ...
  { name: 'Meli Cafe & Juice Bar', address: '301 S. Halsted St, Greektown', website: 'https://www.melicafe.com/', image: 'images/spotlight/meli-cafe.jpg', blurb: 'A bright, all-day breakfast and brunch spot in Greektown, named for the Greek word for honey, with fresh juices and towering plates.' },
