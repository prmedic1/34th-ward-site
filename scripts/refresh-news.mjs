...
const SPOTLIGHT_POOL = [
  ...
  { name: 'Time Out Market Chicago', address: '916 W. Fulton Market, Fulton Market', website: 'https://www.timeoutmarket.com/chicago/', image: 'images/spotlight/time-out-market.jpg', blurb: 'A curated food hall gathering some of the city\'s best chefs under one Fulton Market roof, with a rooftop bar. It is an easy way to sample a dozen local kitchens in one visit.' },
