...
const SPOTLIGHT_POOL = [
  ...
  { name: 'Avec', address: '615 W. Randolph St, West Loop', website: 'https://www.avecrestaurant.com/', image: 'images/spotlight/avec.jpg', blurb: 'One of Restaurant Row\'s originals, a warm cedar-lined room serving Mediterranean small plates from a wood oven at long communal tables. The chorizo-stuffed dates are a Chicago rite of passage.' },
  { name: 'Cruz Blanca Brewery & Taqueria', address: '904 W. Randolph St, West Loop', website: 'https://www.cruzblanca.com/', image: 'images/spotlight/cruz-blanca.jpg', blurb: 'Rick Bayless\'s West Loop taqueria and brewery, pairing wood-grilled tacos and Oaxacan flavors with house-brewed beer and agave cocktails.' },
  { name: 'Rose Mary', address: '932 W. Fulton Market, Fulton Market', website: 'https://www.rosemarychicago.com/', image: 'images/spotlight/rose-mary.jpg', blurb: 'Top Chef winner Joe Flamm\'s Adriatic cooking, a lively mash-up of Italian and Croatian, from handmade pastas to wood-grilled meats on Fulton Market.' },
  { name: 'Duck Duck Goat', address: '857 W. Fulton Market, Fulton Market', website: 'https://www.duckduckgoatchicago.com/', image: 'images/spotlight/duck-duck-goat.jpg', blurb: 'Stephanie Izard\'s playful Chinese restaurant, with hand-pulled noodles, dim sum, and Peking duck in a bustling, mural-lined room.' },
  { name: 'The Aviary', address: '955 W. Fulton Market, Fulton Market', website: 'https://www.theaviary.com/', image: 'images/spotlight/the-aviary.jpg', blurb: 'The Alinea Group\'s avant-garde cocktail lounge, where drinks arrive as edible art and the menu of cocktails is unlike anywhere else in the city.' },
  { name: 'City Winery', address: '1200 W. Randolph St, West Loop', website: 'https://citywinery.com/chicago/', image: 'images/spotlight/city-winery.jpg', blurb: 'An urban winery, restaurant, and intimate live-music venue on Randolph Street, making wine on site and hosting concerts on the riverfront patio.' },
  { name: 'Greek Islands', address: '200 S. Halsted St, Greektown', website: 'https://www.greekislands.net/', image: 'images/spotlight/greek-islands.jpg', blurb: 'A Greektown institution since 1971, packed nightly for flaming saganaki, roast lamb, and warm hospitality across a big, bustling dining room.' },
  { name: 'Athena Greek Restaurant', address: '212 S. Halsted St, Greektown', website: 'https://athenarestaurantchicago.com/', image: 'images/spotlight/athena.jpg', blurb: 'A Greektown mainstay known for classic taverna cooking and one of the neighborhood\'s largest garden patios, framed by Parthenon-style columns.' },
  { name: 'Artopolis Bakery & Cafe', address: '306 S. Halsted St, Greektown', website: 'https://www.artopolischicago.com/', image: 'images/spotlight/artopolis.jpg', blurb: 'Part Greek bakery, part all-day cafe, turning out spanakopita, baklava, and wood-fired breads at the heart of Greektown.' },
  { name: 'Roister', address: '951 W. Fulton Market, Fulton Market', website: 'https://www.roisterrestaurant.com/', image: 'images/spotlight/roister.jpg', blurb: 'The Alinea Group\'s rowdy, open-kitchen restaurant, famous for its whole fried chicken and a counter that puts you right in the fire.' },
  { name: 'Smyth + The Loyalist', address: '177 N. Ada St, West Loop', website: 'https://www.smythandtheloyalist.com/', image: 'images/spotlight/smyth-loyalist.jpg', blurb: 'Two restaurants in one: the two-Michelin-star Smyth upstairs, and downstairs The Loyalist, home to what many call Chicago\'s best burger.' },
  { name: 'Federales', address: '180 N. Morgan St, Fulton Market', website: 'https://www.federaleschicago.com/', image: 'images/spotlight/federales.jpg', blurb: 'Tacos, frozen margaritas, and one of Fulton Market\'s liveliest open-air patios, packed all summer long.' },
  { name: 'Bonci Pizzeria', address: '161 N. Sangamon St, West Loop', website: 'https://bonci.com/', image: 'images/spotlight/bonci.jpg', blurb: 'The Chicago outpost of Rome\'s famous pizza al taglio, sold by the rectangular slice and priced by weight, with ever-changing toppings.' },
  { name: 'The Berghoff', address: '17 W. Adams St, the Loop', website: 'https://www.theberghoff.com/', image: 'images/spotlight/the-berghoff.jpg', blurb: 'Chicago\'s historic German restaurant, serving Wiener schnitzel, house root beer, and steins of beer in the Loop since 1898.' },
  { name: 'Eleven City Diner', address: '1112 S. Wabash Ave, South Loop', website: 'https://www.elevencitydiner.com/', image: 'images/spotlight/eleven-city-diner.jpg', blurb: 'A classic Jewish-style deli and soda fountain in the South Loop, stacked with pastrami, matzo ball soup, and old-fashioned egg creams.' },
  { name: 'Italian Village', address: '71 W. Monroe St, the Loop', website: 'https://www.italianvillage-chicago.com/', image: 'images/spotlight/italian-village.jpg', blurb: 'Three Italian restaurants under one roof in the Loop, serving since 1927. From the old-world Village upstairs to the refined Vivere, it is a downtown institution.' },
  { name: "Miller's Pub", address: '134 S. Wabash Ave, the Loop', website: 'https://www.millerspub.com/', image: 'images/spotlight/millers-pub.jpg', blurb: 'A Loop institution open late since 1935, known for baby back ribs, steaks, and a classic wood-paneled bar hung with celebrity photos.' },
  { name: 'The Gage', address: '24 S. Michigan Ave, the Loop', website: 'https://www.thegagechicago.com/', image: 'images/spotlight/the-gage.jpg', blurb: 'A handsome gastropub across from Millennium Park, pairing elevated pub fare and game dishes with a deep beer and whiskey list.' },
  { name: 'Russian Tea Time', address: '77 E. Adams St, the Loop', website: 'https://www.russianteatime.com/', image: 'images/spotlight/russian-tea-time.jpg', blurb: 'An old-world restaurant beside the Art Institute, famous for borscht, blini, and a long list of house-infused vodkas served in a jewel-box room.' },
  { name: 'Revival Food Hall', address: '125 S. Clark St, the Loop', website: 'https://www.revivalfoodhall.com/', image: 'images/spotlight/revival-food-hall.jpg', blurb: 'A downtown food hall in the landmark National building, gathering more than a dozen local vendors under one roof for a fast, buzzy lunch.' },
  { name: "Tufano's Vernon Park Tap", address: '1073 W. Vernon Park Pl, Little Italy', website: 'https://www.yelp.com/biz/tufanos-vernon-park-tap-chicago', image: 'images/spotlight/tufanos.jpg', blurb: 'A family-run Italian tavern serving Taylor Street since 1930, with no printed menu, hearty pastas, and a cash-only, old-Chicago charm.' },
  { name: "Al's #1 Italian Beef", address: '1079 W. Taylor St, Little Italy', website: 'https://www.alsbeef.com/', image: 'images/spotlight/als-beef.jpg', blurb: 'The original stand where the Italian beef sandwich was born in 1938, still slinging dipped beefs with hot giardiniera on Taylor Street.' },
  { name: 'Rosebud', address: '1500 W. Taylor St, Little Italy', website: 'https://www.rosebudrestaurants.com/', image: 'images/spotlight/rosebud.jpg', blurb: 'The flagship of the Taylor Street Italian institution since 1976, plating big portions of chicken Vesuvio, cavatelli, and old-school red sauce.' },
  { name: 'Pompei', address: '1531 W. Taylor St, Little Italy', website: 'https://www.pompeius.com/', image: 'images/spotlight/pompei.jpg', blurb: 'A Little Italy bakery and Italian counter since 1909, known for square strudel-crust pizza, baked pastas, and Italian ices.' },
  { name: 'Conte di Savoia', address: '1438 W. Taylor St, Little Italy', website: 'https://www.contedisavoia.com/', image: 'images/spotlight/conte-di-savoia.jpg', blurb: 'A beloved Italian and European specialty grocer on Taylor Street, stocked with imported pastas, cheeses, olive oils, and made-to-order sandwiches.' },
  { name: "Manny's Cafeteria & Delicatessen", address: '1141 S. Jefferson St, Near West Side', website: 'https://www.mannysdeli.com/', image: 'images/spotlight/mannys-deli.jpg', blurb: 'A Chicago Jewish deli institution since 1942, sliding trays down the line for towering corned beef, matzo ball soup, and potato pancakes.' },
  { name: "Kasey's Tavern", address: '701 S. Dearborn St, Printers Row', website: 'https://www.kaseystavern.com/', image: 'images/spotlight/kaseys-tavern.jpg', blurb: 'A cozy neighborhood bar anchoring Printers Row since 1990, with a solid beer list and an easy after-work crowd.' },
  { name: 'National Hellenic Museum', address: '333 S. Halsted St, Greektown', website: 'https://www.nationalhellenicmuseum.org/', image: 'images/spotlight/national-hellenic-museum.jpg', blurb: 'Greektown\'s museum of the Greek American experience, with rotating exhibits, a rooftop with skyline views, and a busy calendar of events.' },
  { name: 'WNDR Museum', address: '1130 W. Monroe St, West Loop', website: 'https://www.wndrmuseum.com/', image: 'images/spotlight/wndr-museum.jpg', blurb: 'An immersive art and technology museum in the West Loop, packed with light rooms, mirror installations, and a famous infinity room.' }
];
