...
const SPOTLIGHT_POOL = [
  ...
  { name: 'The Publican', address: '837 W. Fulton Market, Fulton Market', website: 'https://www.thepublicanrestaurant.com/', image: 'images/spotlight/the-publican.jpg?v=20260903', blurb: 'A beer-hall-style anchor of Fulton Market built on oysters, house charcuterie, and pork served at long communal tables. Its farm-focused cooking helped turn the old meatpacking district into a dining destination.' },
  ...
  { name: "Formento's", address: '925 W. Randolph St, West Loop', website: 'https://www.formentos.com/', image: 'images/spotlight/formentos.jpg?v=20260903', blurb: 'A love letter to Italian-American red-sauce classics on Restaurant Row. Sunday gravy, house pastas, and a chicken Parm that regulars swear by, all in a handsome, old-school room.' },
  { name: 'The Original Pancake House', address: '1124 W. Madison St, West Loop', website: 'https://ophchicagoland.com/', image: 'images/original-pancake-house.jpg?v=20260903', blurb: 'A breakfast institution since 1953, famous for the oven-baked Dutch Baby and apple pancakes. The West Loop location on Madison fills its striped-awning patio all summer long.' },
  ...
  { name: 'Publican Quality Meats', address: '825 W. Fulton Market, Fulton Market', website: 'https://www.publicanqualitymeats.com/', image: 'images/spotlight/publican-quality-meats.jpg?v=20260904', blurb: 'The butcher shop, bakery, and sandwich cafe next to The Publican. Grab a pastrami or porchetta sandwich, a loaf of bread, and house-cured meats to take home.' },
  ...
  { name: 'Madison Street Books', address: '1127 W. Madison St, West Loop', website: 'https://www.madstreetbooks.com/', image: 'images/spotlight/madison-street-books.jpg?v=20260904', blurb: 'The West Loop\'s independent bookstore, with a thoughtfully curated selection, a resident shop dog, and a steady calendar of author events and book clubs. A cozy neighborhood anchor on Madison Street.' },
  ...
  { name: 'Bonci Pizzeria', address: '161 N. Sangamon St, West Loop', website: 'https://bonci.com/', image: 'images/spotlight/bonci.jpg?v=20260904', blurb: 'The Chicago outpost of Rome\'s famous pizza al taglio, sold by the rectangular slice and priced by weight, with ever-changing toppings.' },
  ...
  { name: 'Conte di Savoia', address: '1438 W. Taylor St, Little Italy', website: 'https://www.contedisavoia.com/', image: 'images/spotlight/conte-di-savoia.jpg?v=20260904', blurb: 'A beloved Italian and European specialty grocer on Taylor Street, stocked with imported pastas, cheeses, olive oils, and made-to-order sandwiches.' },
